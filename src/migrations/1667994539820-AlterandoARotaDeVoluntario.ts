...
export class AlterandoARotaDeVoluntario1667994539820 implements MigrationInterface {
    name = 'AlterandoARotaDeVoluntario1667994539820'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "volunteer_campaigns" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "createAt" TIMESTAMP NOT NULL DEFAULT now(), "volunteerIdId" uuid, CONSTRAINT "PK_d7b58e94f8aadf0a2f39f88acd1" PRIMARY KEY ("id"))`);
