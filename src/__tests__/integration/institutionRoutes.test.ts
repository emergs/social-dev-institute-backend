...
import { mockedInstitution, mockedInstitutionInvalidCNPJ, mockedLogin } from '../mocks/institutions.mocks'
...
describe("/register/institution", () => {
  ...
  test("PATCH /register/institution/profile -  should be able to update user",async () => {
